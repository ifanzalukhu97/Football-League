    ...
    fun getLeagueInfo(): List<League> {
        return listOf(
            ...
            League(
                ...
                badge = R.drawable.french_ligue_1
            ),
            League(
                id = 4331,
                name = "German Bundesliga",
                description = "The Fußball-Bundesliga (English: Football Federal League), commonly known as the Bundesliga, is a professional association football league in Germany and the football league with the highest average stadium attendance worldwide. At the top of the German football league system, the Bundesliga is Germany's primary football competition. The Bundesliga is contested by 18 teams and operates on a system of promotion and relegation with the 2. Bundesliga. Seasons run from August to May. Most games are played on Saturdays and Sundays, with a few games played during weekdays. All of the Bundesliga clubs qualify for the DFB-Pokal. The winner of the Bundesliga qualifies for the DFL-Supercup.\n" +
                        "\n" +
            ...
            League(
                ...
                badge = R.drawable.italian_serie_a
            ),
            League(
                id = 4335,
                name = "Spanish La Liga",
                description = "The Primera División, commonly known as La Liga and as La Liga Santander for sponsorship reasons, is the top professional association football division of the Spanish football league system. Administrated by the Liga de Fútbol Profesional (LFP), La Liga is contested by 20 teams, with the three lowest-placed teams relegated to the Segunda División and replaced by the top two teams in that division plus the winner of a play-off.\n" +
                        "\n" +
                ...
                badge = R.drawable.spanish_la_liga
            ),
            League(
                id = 4346,
                ...
                badge = R.drawable.american_mayor_league
            ),
            League(
                id = 4344,
                name = "Protugeuese Premiera Liga",
                description = "The Primeira Liga (First League; Portuguese pronunciation: ), formerly called Primeira Divisão), is the top professional association football division of the Portuguese football league system.\n" +
                        "\n" +
            ...
            League(
                ...
                badge = R.drawable.english_league_1
            )
        )
