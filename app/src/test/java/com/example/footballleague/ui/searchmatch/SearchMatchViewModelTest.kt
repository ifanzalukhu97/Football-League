...
class SearchMatchViewModelTest {
    ...
    @Test
    fun searchMovie() = testCoroutineScope.runBlockingTest {
        ...
        viewModel.searchMovieByQuery("example query")
    ...
    @Test
    fun searchMovie_queryIsBlank() = testCoroutineScope.runBlockingTest {
        viewModel.searchMovieByQuery("")
    ...
    @Test
    fun searchMovie_resultIsEmpty() = testCoroutineScope.runBlockingTest {
